...
brew install --cask font-aldrich font-anaheim font-anton font-assistant font-barlow font-cuprum font-dosis font-fira-code font-gudea font-inconsolata font-jetbrains-mono font-lato font-noto-sans font-nunito-sans font-open-sans font-oswald font-redacted-script font-source-code-pro font-source-sans-3 font-ubuntu-mono font-victor-mono
